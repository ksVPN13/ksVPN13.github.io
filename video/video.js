...
let pWidth;
let pHeight;
const imgSrc = 'https://preview.redd.it/mw4e64kb27w71.gif?width=640&format=mp4&s=7c9f28915abf0a41516a17f0250efc985dea8fde';
let winCondition;
let gameOver = false;
let clicks = 0;
...
function checkWin() {
    ...
    if (isEqual(currentLayout, winCondition)) {
        ...
        //remove blank and replace with correct slide
        ...
        sImg.style.height = pHeight + 'vh';
        //margins offset the image to show the right piece for each slide
        sImg.style.margin = '0 0 0 0';
        //add slide image to container element
        document.getElementById('r0s0').appendChild(sImg);
        */
